  ...
  const mintNftHandler = async () => {
    try {
      ...
      if (ethereum) {
        ...
        // si l'utilisateur n'a pas déjà mint deux fois:
        if (contract.methods.balanceOf(accounts[0]).call() > 2) {alert("vous avez déjà mint deux fois");return false;}
  ...
  return (
    <div className='App'>
      <div className='main-app'>
          <h1>Récupérer des nfts</h1>
          <p>Votre portefeuille <strong>{currentAccount}</strong> est connecté. </p>
